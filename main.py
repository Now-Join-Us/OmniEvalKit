...
# 数学() 代码() 法律(lawbench) 医疗(只有一些零散的数据) 金融(近20)
# RAG
...
<<<<<<< HEAD
            dataset = get_dataset(dataset_name=dataset_name, dataset_file_path=dataset_file_path, rank=rank, world_size=world_size, preloaded_image_num=0)
=======
...
<<<<<<< HEAD
        ...
        dataset = get_dataset(dataset_name=dataset_name, dataset_file_path=dataset_file_path, rank=rank, world_size=world_size, image_url=args.image_url, preloaded_image_num=args.preloaded_image_num)
=======
            responses = Response(log_path, save_steps=args.save_steps, rank=rank, world_size=world_size)
...
<<<<<<< HEAD
            estimate_func=args.estimate_func,
=======
>>>>>>> aef4b81d4d7526f3d22d331a4e308ff367100185
            **args.eval_args
        )
