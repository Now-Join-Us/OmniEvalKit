...
def process_results(results, answer):
    preds, golds = results, answer
    max_em = 0
    max_f1 = 0
...
class DropDataset(Dataset):
    ...
    def calculate(self, data, base_dict, base_calculate_kwargs):
        return process_results(base_calculate_kwargs['filtered_r'], base_calculate_kwargs['gold'])

data_core = DropDataset