...
from dataloaders.estimators.utils import shrink_corresponding
...
class MMEDataset(Dataset):
    ...
    def estimate(self, scores, categories, sub_categories):
        raw_statistics = sum_or_avg(
            scores=scores,
            categories=None,
            sub_categories=sub_categories,
            e_type='avg'
        )
        shrunk_results = shrink_corresponding(scores, [data['shrink_pair'] for data in self],
