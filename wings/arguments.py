...
class DataArguments:
    ...
    prefetch: bool = False
    time_str: str = ''
    unchange_passing_key: Optional[str] = field(default=None)

    tabular_source_data_path: Optional[str] = field(default='')
    tabular_source_data: Optional[str] = field(default='')
...
class ModelArguments:
    ...
    tabular_encoder_path: Optional[str] = field(default='')
    tabular_cache_path: Optional[str] = field(default='')
